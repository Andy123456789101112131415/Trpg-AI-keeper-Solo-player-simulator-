...
import { CULT_LORE } from '@/data/knowledge';
...
const SCENE_RECALLS: Record<string, string> = {
  '深潜者': `[系统召回] 千面之门对深潜者教会的态度：深潜者是侍奉大衮与克苏鲁的低级神话生物。千面之门将其视为"害虫"——定期清理即可。持钥人以上成员都接受过对抗深潜者的标准训练。`,
  '仪式': `[系统召回] 千面之门仪式知识：标准仪式需睁眼者以上主持。小仪式（黑法老之赐）3-5MP。中型（召唤混沌眷属）10MP+1/1D8 SAN。大型（黑法老降临）需3人协助。被打断可能导致混沌反噬。`,
  '奈亚': `[系统召回] 奈亚拉托提普是外神之一，拥有上千种"面相"。千面之门侍奉其"黑法老"面相。奈亚行事难以预测——有时帮助信徒，有时以信徒的绝望为乐。黄金面具以上能与奈亚直接对话。`,
  '教团': `[系统召回] 千面之门以七环制运作。对上级需尊称（如"睁眼者大人"）。晋升需满足特定条件并经历"面具试炼"。分部间相对独立。`,
};
